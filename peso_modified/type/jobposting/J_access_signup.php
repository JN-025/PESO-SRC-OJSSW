...
<?php
        if(isset($_POST['signup'])){
            ...
            $message = "Our $name would like to request an access for Job Posting.";
        
            $query = "INSERT INTO `access_requests` (`access_id`, `peso_id`, `name`, `email`, `password`, `message`, `accessType`, `date`) VALUES (NULL, '$peso_id', '$name', '$email', '$password', '$message', 'Job Posting', CURRENT_TIMESTAMP)";
