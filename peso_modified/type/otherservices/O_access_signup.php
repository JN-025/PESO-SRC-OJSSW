...
<?php
        if(isset($_POST['signup'])){
            ...
            $message = "Our $name would like to request an access for Other Services.";
        
            $query = "INSERT INTO `access_requests` (`access_id`, `peso_id`, `name`, `email`, `password`, `message`, `accessType`, `date`) VALUES (NULL, '$peso_id', '$name', '$email', '$password', '$message', 'Other Services', CURRENT_TIMESTAMP)";
        ...
        <div class="main-row">
            ...
            <div class="field-space"></div>
                ...
                <form action="" method="post">
                    ...
                    <br><br>
                    <h5>Already have an Account?&nbsp;&nbsp;<a href="O_access_login.php">LOG IN</a></h5>
                    </div>
