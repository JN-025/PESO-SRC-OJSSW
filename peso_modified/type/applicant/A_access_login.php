...
if (!isset($_SESSION['peso_id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM access_account WHERE email=? AND password=? AND status='Approved' AND type='Applicant'";
        ...
        if ($result->num_rows === 1) {
            ...
            $msg = "<div class='alert alert-danger'>Email or password do not match, or your account is not approved for applicant.</div>";
        }
        ...
        <div class="main-row">
            ...
            <?php echo $msg; ?>
                ...
                <form action="" method="post">
                    ...
                    <button name="submit" type="submit" class="access">Log In</button>
                    <br><br>
