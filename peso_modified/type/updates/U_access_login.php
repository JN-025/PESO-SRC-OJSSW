...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM access_account WHERE email=? AND password=? AND status='Approved' AND type='Updates'";
    ...
    if ($result->num_rows === 1) {
        ...
        header('location: updates_homepage.php');
    } else {
        $msg = "<div class='alert alert-danger'>Email or password do not match, or your account is not approved for Updates.</div>";
    }
        ...
        <div class="main-row">
            ...
            <?php echo $msg; ?>
                ...
                <form action="" method="post">
                    ...
                    <br><br>
                    <h5>Create an Account?&nbsp;&nbsp;<a href="U_access_signup.php">SIGN UP</a></h5>
                    </div>
