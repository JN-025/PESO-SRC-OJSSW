...
<div class="topside-container">
    <div class="sidenav">
        ...
        <a href="jobpost.php" <?php echo isActivePage("jobpost.php"); ?>><i class="bi bi-file-post"></i>&nbsp;Job Post</a>
        <a href="jobposting.php" <?php echo isActivePage("jobposting.php"); ?>><i class="bi bi-search"></i>&nbsp;Job Posting</a>
        <a href="#" <?php echo isActivePage("#"); ?>><i class="bi bi-bell" style="font-size:20px"></i>&nbsp;Applications</a>
