...
<table border="1" class="styled-table">
    <thead>
        ...
        <th onclick="sortTable(1)">First Name <span id="arrow1"></span></th>
        <th onclick="sortTable(2)">Last Name <span id="arrow2"></span></th>
    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                echo "<button onclick='openImageModal(\"{$row['birthCert_img']}\")'>See Full Detail</button>";
                echo "</td>";
...
if ($page > 1) {
    echo "<a href='spes_approval.php?page=" . ($page - 1) . "'>&laquo; Prev</a>";
}
for ($i = 1; $i <= $total_pages; $i++) {
    $activeClass = ($i == $page) ? 'active' : '';
    echo "<a class='$activeClass' href='spes_approval.php?page=$i'>$i</a>";
}
if ($page < $total_pages) {
    echo "<a href='spes_approval.php?page=" . ($page + 1) . "'>Next &raquo;</a>";
}
    echo "</div>";
?>
</div>
