...
if(isset($_POST["submit"])){
    ...
    $insert = "INSERT INTO p_accounttb (name, station, position, contactNum, email, password) VALUES (?,?,?,?,?,?)";
    $stmt = mysqli_stmt_init($conn);
    if (!mysqli_stmt_prepare($stmt, $insert)){
        echo "error database";
    } else {
        mysqli_stmt_bind_param($stmt, "ssssss", $name, $station, $position, $contactNum, $email, $password);
        ...
        <div class="main-row">
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-col-1">
                    <input type="text" placeholder="Division/Station" name="station" required maxlength="50">
                    </div>
                    <div class="form-col-1">
                    <input type="text" placeholder="Position" name="position" required maxlength="50">
                    </div>
