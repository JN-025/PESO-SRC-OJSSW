<link rel="stylesheet" href="../assets/css/applicant_profilenav.css">
...
<div class="profilenav">
        ...
        <a href="#" class="noHover">
            <center><img src="../assets/img/profilesample.png" style="height: 120px; width: 120px; border-radius: 50%;"></center>
        </a>
        <br>
        <button type="" class="change" name="submit">Change Picture</button>
        </center>
        <br>
