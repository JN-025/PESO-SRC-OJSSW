                    ...
                    <div class="card4">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-card">
                                ...
                                <input type="text" name="educLevel" placeholder="Highest Educational Level" required min="" max="">
                                </div>
                            </div>
                            ...
                            <div class="form-card">
                                ...
                                <div class="form-col-2">
                                <input type="text" name="gradYear" placeholder="Year Graduated/Last Year Attended" required min="" max="">
                                </div>
                            </div>
                            ...
                            <div class="form-card">
                                ...
                                <div class="form-col-2">
                                <input type="text" name="school" placeholder="School/University" required min="" max="">
                                </div>
                            </div>
                            ...
                            <div class="form-card">
                                ...
                                <div class="form-col-2">
                                <input type="text" name="course" placeholder="Course/Program" required min="" max="">
                                </div>
                            </div>
                            ...
                            <div class="form-card">
                                ...
                                <div class="form-col-2">
                                <input type="text" name="award" placeholder="Awards/Honors Received" required min="" max="">
                                </div>
                            </div>
