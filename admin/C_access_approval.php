...
<body>
    ...
    <div class="card1">
        ...
        <?php
            ...
            $query = "select * from `access_requests` where accessType = 'Company';";
            if(count(fetchAll($query))>0){
                ...
                <br> <br>
                  ...
                  <p>
                  <a href="C_access_accept.php?access_id=<?php echo $row['access_id'] ?>" class="btn btn-primary my-2">Accept</a>
