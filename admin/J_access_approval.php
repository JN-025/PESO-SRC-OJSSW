...
<body>
    ...
    <div class="card1">
        ...
        <?php
            ...
            $query = "select * from `access_requests` where accessType = 'Job Posting';";
            if(count(fetchAll($query))>0){
                ...
                <br> <br>
                  ...
                  <p>
                  <a href="J_access_accept.php?access_id=<?php echo $row['access_id'] ?>" class="btn btn-primary my-2">Accept</a>
